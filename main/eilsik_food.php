...
$res = mysqli_query($con, "select * from main_eiltbl where eilID = '".$eilID."'");
...
<div id="wrap">
  ...
  <div id="header2">
    <div class="container2">
        ...
        $eilName = $row['eilName'];
        ?>
        <div class="foodname"> <?php echo "<strong>".$eilName."</strong>"; ?> </div>

        <div class="back_button">
          <input type="image" name="button"  src='../img/back_icon.png' style="width:30px; height:30px;" onClick="location.href='eilsik_main.php'">
        </div>
    ...
    <div id="thumb">
      <div class="container">
        <?php
         ...
         echo '<a href="../good/eilsik_good.php?eilID='.$eilID.'"><img id="img_a" src="../img/good.png"></a>';
