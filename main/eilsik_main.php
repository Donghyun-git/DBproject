...
<html lang="ko">
  <head>
   ...
   .main_logo{ height:220px;}
    ...
    #header1 {  height: 220px; border-top: 1px solid gray; border-bottom: 1px solid gray; }
  ...
  .bg{ width: 1300px; height: 1630px; background-color:white; margin: 0 auto;}
    ...
    .main_word{ font-size: 30px; margin-left: 300px; margin-top: 50px;}
        ...
        <table>
          <tr>
            <td>
              ...
              <td>
                <span class="main_word"><strong>일식 공유방</strong></span>
              </td>
              <td class="write_button">
                <input type="image" name="button"  src='../img/write_icon.png' style="width:30px; height:30px;" onClick="location.href='../write/eilsik.php'">
...
<ul>
  ...
  $res = mysqli_query($con, "select * from main_eiltbl where eilID LIKE 'E%'");
...
<?php
  ...
  echo "<br>";
  echo '<a href="eilsik_food.php?eilID='.$row['eilID'].'"><img src="data:image/png;base64, '.base64_encode($row['image'] ).'" height="200" width="200"/ ></a>';
  echo "<br>";
  echo $row['eilName'];
  echo "<br>";
  echo '<img src="../img/good.png" height="35" width="35"/>';
  echo $row['good'];
  echo "<br>";
  }
  ?>
