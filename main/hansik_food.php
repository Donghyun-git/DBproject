...
$res = mysqli_query($con, "select * from main_hantbl where hanID = '".$hanID."'");
...
<div id="wrap">
  ...
  <div id="header2">
    <div class="container2">
        ...
        $hanName = $row['hanName'];
        ?>
        <div class="foodname"> <?php echo "<strong>".$hanName."</strong>"; ?> </div>

            <div class="back_button">
              <input type="image" name="button"  src='../img/back_icon.png' style="width:30px; height:30px;" onClick="location.href='hansik_main.php'">
            </div>
    ...
    <div id="thumb">
      <div class="container">
       ...
       echo '<a href="../good/hansik_good.php?hanID='.$hanID.'"><img id="img_a" src="../img/good.png"></a>';
