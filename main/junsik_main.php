        ...
        <table>
          <tr>
            <td>
              ...
              <td>
                <span class="main_word"><strong>중식 공유방</strong></span>
              </td>
              <td class="write_button">
                <input type="image" name="button"  src='../img/write_icon.png' style="width:30px; height:30px;" onClick="location.href='../write/junsik.php'">
              </td>
            </tr>
          </table>
      </div>
...
<ul>
  ...
  $res = mysqli_query($con, "select * from main_jungtbl where jungID LIKE 'J%'");
...
<?php
    ...
    echo "<br>";
    echo '<a href="jungsik_food.php?jungID='.$row['jungID'].'"><img src="data:image/png;base64, '.base64_encode($row['image'] ).'" height="200" width="200"/ ></a>';
    echo "<br>";
    echo $row['jungName'];
    echo "<br>";
