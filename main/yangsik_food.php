...
<!--_main.php에서 hanID값 받아오기-->
<?php
$yangID = $_GET['yangID'];
$con = mysqli_connect("localhost", "root", "1234", "ska_ska");
$res = mysqli_query($con, "select * from main_yangtbl where yangID = '".$yangID."'");
...
<div id="wrap">
  ...
  <div id="header2">
    <div class="container2">
        ...
        <!--음식이름-->
        <?php
        $yangName = $row['yangName'];
        ?>
        <div class="foodname"> <?php echo "<strong>".$yangName."</strong>"; ?> </div>

        <div class="back_button">
          <input type="image" name="button"  src='../img/back_icon.png' style="width:30px; height:30px;" onClick="location.href='yangsik_main.php'">
        </div>
    ...
    <div id="thumb">
      <div class="container">
        <?php
           ...
           echo '<a href="../good/yangsik_good.php?yangID='.$yangID.'"><img id="img_a" src="../img/good.png"></a>';
    ...
    <div id="content5">
      <div class="container">
        <div style="width: 100%; text-align: center; margin-bottom: 50px; border-bottom: 3px solid black;">
