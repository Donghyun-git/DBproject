...
<html lang="ko">
  <head>
   ...
   .main_logo{ height:220px;}
    ...
    .container1 {
      display: inline-block; text-align: center; width: 1100px;
       margin: 0 auto; height: inherit;  background-color: #caccd1;
        border-radius:40px;}
        ...
        <table>
          <tr>
            <td>
              ...
              <td>
                <span class="main_word"><strong>양식 공유방</strong></span>
              </td>
              <td class="write_button">
                <input type="image" name="button"  src='../img/write_icon.png' style="width:30px; height:30px;" onClick="location.href='../write/yangsik.php'">
              </td>
            </tr>
          </table>
      </div>
...
<ul>
  ...
  $res = mysqli_query($con, "select * from main_yangtbl where yangID LIKE 'Y%'");
...
<?php
  ...
  echo "<br>";
  echo '<a href="yangsik_food.php?yangID='.$row['yangID'].'"><img src="data:image/png;base64, '.base64_encode($row['image'] ).'" height="200" width="200"/ ></a>';
  echo "<br>";
  echo $row['yangName'];
  echo "<br>";
