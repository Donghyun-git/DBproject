...
<div id="wrap">
  <div id="header1">
    <div class="container">
<a href="../main/eilsik_main.php"> <img src="../img/main_logo.png"> </a>
    </div>
  </div>
  <div id="header2">
    <div class="container">
 <span class="word"> <strong> 일식 레시피 작성 </strong> </span>
    </div>
  </div>
  <div id="contents">
    <div class="container">
      <form method = "post" action = "write_eil_result.php" enctype="multipart/form-data">
      <table  style="padding-top:20px" width=900 border=0 cellpadding=2 >
              ...
              <table class = "table2">
                      ...
                      <tr>
                      <td>음식 이름</td>
                      <td><input type = text name = "eilName" size=60 ></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div><span class="word1">간장</span> <div class="twoword">
                            <select name="soy" style="width: 80px; height:30px">
