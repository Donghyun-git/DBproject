...
<html lang="ko">
  ...
  .word{ font-size: 35px; padding-top:30px;}
...
<div id="wrap">
  <div id="header1">
    <div class="container">
<a href="../main/hansik_main.php"> <img src="../img/main_logo.png"> </a>
    </div>
  </div>
  <div id="header2">
    <div class="container">
 <span class="word"> <strong>한식 레시피 작성</strong> </span>
    </div>
  </div>
  <div id="contents">
    <div class="container">
      <form method = "post" action = "write_result.php" enctype="multipart/form-data">
      <table  style="padding-top:20px" width=900 border=0 cellpadding=2 >
              ...
              <table class = "table2">
                      ...
                      <tr>
                      <td>음식 이름</td>
                      <td><input type = text name = "hanName" size=60 ></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div><span class="word1">고추장</span> <div class="threeword">
                            <select name="GCJ" style="width: 80px; height:30px">
                          ...
                          <div class="word2"><span class="word1">된장</span> <div class="twoword"> <select name="DJ" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
                          ...
                          <div class="word2"><span class="word1">참기름</span> <div class="threeword"><select name="chamoil" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
                          ...
                          <div class="word2"><span class="word1">올리고당</span> <select name="oligo" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
