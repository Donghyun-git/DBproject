...
<html lang="ko">
  ...
  .twoword { display: inline-block; margin-left:48px; }

  .threeword{ display: inline-block; margin-left: 32px;}

  .fourword{ display: inline-block; margin-left: 16px;}
...
<div id="wrap">
  <div id="header1">
    <div class="container">
<a href="../main/yangsik_main.php"> <img src="../img/main_logo.png"> </a>
    </div>
  </div>
  <div id="header2">
    <div class="container">
 <span class="word"> <strong> 양식 레시피 작성 </strong> </span>
    </div>
  </div>
  <div id="contents">
    <div class="container">
      <form method = "post" action = "write_yang_result.php" enctype="multipart/form-data">
      <table  style="padding-top:20px" width=900 border=0 cellpadding=2 >
              ...
              <table class = "table2">
                      ...
                      <tr>
                      <td>음식 이름</td>
                      <td><input type = text name = "yangName" size=60 ></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div><span class="word1">토마토소스</span>
                            <select name="tomato" style="width: 80px; height:30px">
                          ...
                          <div class="word2"><span class="word1">크림소스</span> <div class="fourword"> <select name="cream" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
                          ...
                          <div class="word2"><span class="word1">버터</span> <div class="twoword">  <select name="butter" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
                          ...
                          <div class="word2"><span class="word1">고춧가루</span> <div class="fourword"><select name="RP" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
                          ...
                          <div class="word2"><span class="word1">파슬리가루</span> <select name="PA" style="width: 80px; height:30px">
                              <option selected>0</option>
                              <option>0.5</option>
                              <option>1</option>
                              <option>1.5</option>
